...
type GetListThreadRes struct {
	...
	Tags           []entity.SecureThreadTag         `json:"tags"`
	PartnerTypes   []entity.SecureThreadPartnerType `json:"partner_types"`
	Institutions   []entity.SecureThreadInstitution `json:"institutions"`
}
