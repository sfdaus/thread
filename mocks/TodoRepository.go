...
func (_m *TodoRepository) Fetch(ctx context.Context) ([]domain.Todo, error) {
	ret := _m.Called(ctx)
...
func (_m *TodoRepository) GetByID(ctx context.Context, id int64) (domain.Todo, error) {
	ret := _m.Called(ctx, id)
